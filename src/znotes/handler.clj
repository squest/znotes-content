(ns znotes.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [znotes.routes.home :refer [home-routes]]
            [znotes.middleware :as middleware]
            [znotes.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "znotes is shutting down...")
  (stop-nrepl)
